...
### BR-5: Геолокация по умолчанию выключена
...
### BR-6: Экспорт через системный диалог
...
**Связанные требования:** BR-1 (только съемка), BR-5 (геолокация выключена)

---

### UC-2: Отправить в чат
...
**Связанные требования:** BR-2 (уникальный ID), BR-3 (дубликаты ОК), BR-7 (пересылка)

---

### UC-3: Проверка у получателя
...
**Связанные требования:** BR-4 (автопроверка офлайн)
...
**Связанные требования:** BR-6 (экспорт через системный диалог)
...
### US-2: Блокировка редактирования в Evidence
```gherkin
